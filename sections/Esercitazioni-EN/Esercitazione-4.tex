...
\draw [ line width=0.6pt ] (2.5,12.75) rectangle  node {\normalsize $z^{-1}$} (5,11.75);
\draw [line width=0.6pt, ->, >=Stealth] (1.5,12.25) -- (2.5,12.25);
\draw [line width=0.6pt, ->, >=Stealth] (5,12.25) -- (6.25,12.25);
\draw [ line width=0.6pt ] (6.5,12.25) circle (0.25cm);
\draw [line width=0.6pt, short] (6.25,12) -- (6.75,12.5);
\draw [line width=0.6pt, short] (6.25,12.5) -- (6.75,12);
\draw [line width=0.6pt, ->, >=Stealth] (6.5,11) -- (6.5,12);
\draw [line width=0.6pt, ->, >=Stealth] (6.75,12.25) -- (8,12.25);
\draw [ line width=0.6pt ] (8.25,12.25) circle (0.25cm);
\draw [line width=0.6pt, short] (8.25,12.5) -- (8.25,12);
\draw [line width=0.6pt, short] (8,12.25) -- (8.5,12.25);
\draw [line width=0.6pt, ->, >=Stealth] (8.25,11) -- (8.25,12);
\draw [ line width=0.6pt ] (8.25,10.75) circle (0.25cm);
\draw [line width=0.6pt, short] (8.25,11) -- (8.25,10.5);
\draw [line width=0.6pt, short] (8,10.75) -- (8.5,10.75);
\draw [line width=0.6pt, ->, >=Stealth] (10,10.75) -- (8.5,10.75);
\draw [line width=0.6pt, ->, >=Stealth] (8.5,12.25) -- (15,12.25);
\draw [line width=0.6pt, ->, >=Stealth] (12.5,12.25) -- (12.5,11.25);
\draw [ line width=0.6pt ] (11.25,11.25) rectangle  node {\normalsize $z^{-1}$} (13.75,10.25);
\draw [line width=0.6pt, ->, >=Stealth] (12.5,10.25) -- (12.5,9.25);
\draw [ line width=0.6pt ] (11.25,9.25) rectangle  node {\normalsize $z^{-1}$} (13.75,8.25);
\draw [ line width=0.6pt ] (10.25,10.75) circle (0.25cm);
\draw [line width=0.6pt, ->, >=Stealth] (11.25,10.75) -- (10.5,10.75);
\draw [line width=0.6pt, ->, >=Stealth] (11.25,8.75) -- (10.5,8.75);
\draw [ line width=0.6pt ] (10.25,8.75) circle (0.25cm);
\draw [line width=0.6pt, ->, >=Stealth] (8.25,9) -- (8.25,10.5);
\draw [line width=0.6pt, short] (10,8.75) -- (8.25,8.75);
\draw [line width=0.6pt, short] (8.25,8.75) -- (8.25,9);
\draw [line width=0.6pt, short] (10,11) -- (10.5,10.5);
\draw [line width=0.6pt, short] (10,10.5) -- (10.5,11);
\draw [line width=0.6pt, short] (10,9) -- (10.5,8.5);
\draw [line width=0.6pt, short] (10,8.5) -- (10.5,9);
\draw [short] (12.25,10.75) -- (12.25,10.75);
\draw [short] (14,14) -- (14,14);
\draw [short] (14,14) -- (14,14);
\draw [short] (13.5,10.75) -- (13.5,10.75);
\draw [short] (14.5,10.75) -- (14.5,10.75);
\draw [short] (14.5,10.75) -- (14.5,10.75);
\end{circuitikz}
}
