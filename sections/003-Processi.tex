...
\subsection{Trasformazioni dei processi casuali}

\subsubsection{Trasformazioni lineari}

\subsubsection{Trasformazione LTI su processo WSS}

\subsubsection{Trasformazione lineare su processo gaussiano}

\subsubsection{Modulazione di ampiezza}

\subsubsection{Modulazione analogica di fase}

\subsection{Densità spettrale di potenza per i processi casuali stazionari WSS}

\subsubsection{Potenza media per processi stazionari}

\subsubsection{Densità spettrale di potenza}

\subsection{Medie temporali ed ergodicità}

\subsubsection{Medie temporali}

\subsubsection{Ergodicità}

\subsection{Esempio conclusivo - Trasmissione 2-PAM}
